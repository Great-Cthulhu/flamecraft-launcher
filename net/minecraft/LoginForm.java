  ...
  private JPanel buildLoginPanel() {
    ...
    ActionListener ChooseServer = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
	        ...
	        server = (String)box.getSelectedItem();
	        	
		    if (server == Config.servername1){
			        	server = "1";
		    Config.StrDown = Config.StrDown1;
		    Config.md51client = Config.md51client1;
		    Config.md5server = Config.md5server1;
		    
// *************************************************************************
		    }else if (server == Config.servername2){
						server = "2";
		     Config.StrDown = Config.StrDown2;
		     Config.md51client = Config.md51client2;
		     Config.md5server = Config.md5server2;
		    
// *************************************************************************		    	
		    }else if (server == Config.servername3){
	        			server = "3";
	        Config.StrDown = Config.StrDown3;
	        Config.md51client = Config.md51client3;
	        Config.md5server = Config.md5server3;
...
// *************************************************************************
    ...
    try
    {
      ...
      {
        TransparentLabel accountLink = new TransparentLabel("Регистрация на сайте") {
        ...
        accountLink.addMouseListener(new MouseAdapter() {
          public void mousePressed(MouseEvent arg0) {
            try {
              Util.openLink(new URL(Config.news = Config.regURL).toURI());
            } catch (Exception e) {
              e.printStackTrace();
            }
          }
